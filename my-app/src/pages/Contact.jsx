...
export default function Contact() {
  ...
  // Form & UI States
  const [formData, setFormData] = useState({ fullName: '', email: '', subject: '', category: '', message: '' });
  ...
  const validateForm = () => {
    ...
    else if (formData.message.trim().length < 10) tempErrors.message = c.form.errMinMsg;
