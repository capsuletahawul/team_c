...
//==
    ...
    // ==========================================
    // Add this exact block for the SignIn page
    login: {
      title: "تسجيل الدخول",
      subtitle: "مرحباً بك مجدداً في كبسولة تحول، يرجى إدخال بياناتك للمتابعة.",
    ...
    social: ["Google", "LinkedIn"], // Required for the social-row buttons
    ...
    // Add this to the ar section
    signup: {
      title: "إنشاء حساب",
      subtitle: "انضم إلى كبسولة تحول وابدأ رحلتك.",
      name: "الاسم الكامل",
      namePh: "أدخل اسمك الكامل",
      email: "البريد الإلكتروني",
      emailPh: "أدخل بريدك الإلكتروني",
      ...
      passwordPh: "أدخل كلمة المرور",
      role: "طبيعة الحساب",
      roleOptions: ["طالب متعلم", "مدرب خبير", "ممثل شركة"],
      terms: "أوافق على الشروط والأحكام وسياسة الخصوصية",
      submit: "إنشاء حساب",
      or: "أو التسجيل بواسطة",
      haveAccount: "لديك حساب بالفعل؟",
      switchLink: "تسجيل الدخول"
    },
    strengthLabel: "قوة كلمة المرور",
    ...
    trainerDetails: {
      ...
      form: {
        name: "الاسم الكامل",
        email: "البريد الإلكتروني للاستجابة",
        message: "تفاصيل رسالتك أو استشارتك",
    ...
    contact: {
      hero: {
        badge: "دعم فني متواصل",
        title: "تواصل معنا",
        subtitle: "نحن هنا لمساعدتك في قيادة تحولك الرقمي وبناء مسيرتك التقنية. أرسل استفسارك وسنرد عليك في أقرب وقت."
      },
      form: {
        title: "أرسل رسالة",
        alertTitle: "تم الإرسال بنجاح!",
        alertDesc: "شكراً لتواصلك معنا. سنقوم بالرد عليك في أقرب وقت ممكن.",
        fullName: "الاسم الكامل",
        ...
        category: "التصنيف",
        categorySelect: "اختر التصنيف المناسب",
        cat1: "المعسكرات والدورات",
        cat2: "الدعم الفني",
        cat3: "الشراكات والأعمال",
        cat4: "استفسار آخر",
        message: "نص الرسالة",
        ...
        errMinMsg: "يجب أن تحتوي الرسالة على 10 أحرف على الأقل."
      },
      info: {
        emailTitle: "المراسلة المباشرة",
        ...
        locationValue: "الرياض، حي العليا",
        hoursTitle: "ساعات العمل",
        hoursDesc: "أوقات استجابة الدعم الفني",
...
contact: {
      hero: {
        badge: "24/7 Support",
        title: "Get in Touch",
        subtitle: "We are here to help you deploy your digital shift. Send your inquiry and we will get back to you shortly."
      },
      form: {
        title: "Send a Message",
        alertTitle: "Sent Successfully!",
        alertDesc: "Thank you for reaching out. We will get back to you as soon as possible.",
        fullName: "Full Name",
        ...
        cat1: "Bootcamps & Courses",
        cat2: "Technical Support",
        cat3: "Business Partnerships",
        cat4: "Other Inquiry",
        message: "Message",
        ...
        errMinMsg: "Message must be at least 10 characters long."
      },
      info: {
        ...
        locationValue: "Riyadh, Olaya District",
        hoursTitle: "Working Hours",
        hoursDesc: "Support response times",
        hoursValue: "Sun - Thu: 9 AM - 5 PM"
      }
    },
// Add this to the en section
    signup: {
      title: "Create Account",
      subtitle: "Join Capsule Tahawul and start your journey.",
      name: "Full Name",
      ...
      role: "Account Type",
      roleOptions: ["Student", "Expert Trainer", "Company Rep"],
...
coursesOverview: {
  ...
  mockCourses: [
    ...
    login: {
      title: "Sign In",
      subtitle: "Welcome back to Capsule Tahawul. Please enter your details to continue.",
      email: "Email Address",
      ...
      switchLink: "Create a new account"
    },
    social: ["Google", "LinkedIn"], // Required for the social-row buttons
