...
} as const satisfies Record<"ar" | "en", any>; 
// Using `any` on the Record values here acts as a structure check 
// while letting the individual values (like dir: "rtl" or "ltr") keep their strict types!